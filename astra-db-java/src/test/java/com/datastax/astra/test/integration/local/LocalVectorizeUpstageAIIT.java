...
/**
 * Vectorize integration tests using UpstageAI embeddings against local HCD/DSE.
 * <p>
 * Tests require:
 * <ul>
 *   <li>Local HCD or DSE instance running with vectorize enabled</li>
 *   <li>UpstageAI API key configured in test-config.properties or UPSTAGE_API_KEY env var</li>
 * </ul>
 */
@EnabledIfLocalAvailable
@Slf4j
@DisplayName("Local Vectorize UpstageAI Integration Tests")
public class LocalVectorizeUpstageAIIT extends AbstractVectorizeApiHeaderIT {
