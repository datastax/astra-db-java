...
public class TableDeleteOneOptions extends CommandOptions<TableDeleteOneOptions> {
     ...
     *      current command.
     */
    public TableDeleteOneOptions sort(Sort... sort) {
     ...
     */
    public TableDeleteOneOptions sort(String vectorize, Sort ... sorts) {
     ...
     * @return current command
     */
    public TableDeleteOneOptions sort(float[] vector, Sort... sorts) {
    ...
    /**
     * Builder for creating {@link TableDeleteOneOptions} instances with a fluent API.
     */
    @Deprecated
    public static class Builder {
         ...
         * @return A new {@link TableDeleteOneOptions} instance configured with the provided sort criteria.
         */
        public static TableDeleteOneOptions sort(Sort... sort) {
            return new TableDeleteOneOptions().sort(sort);
        }
         ...
         * @param sorts The sort criteria to be applied to the findOne operation.
         * @return A new {@link TableDeleteOneOptions} instance configured with the provided vectorize criteria.
         */
        public static TableDeleteOneOptions vectorize(String vectorize, Sort... sorts) {
            return new TableDeleteOneOptions().sort(vectorize, sorts);
        }
         ...
         * @param sorts The sort criteria to be applied to the findOne operation.
         * @return A new {@link TableDeleteOneOptions} instance configured with the provided vector criteria.
         */
        public static TableDeleteOneOptions vector(float[] vector, Sort... sorts) {
            return new TableDeleteOneOptions().sort(vector, sorts);
        }
    }
