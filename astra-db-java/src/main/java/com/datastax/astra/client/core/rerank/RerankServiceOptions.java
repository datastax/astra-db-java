...
public class RerankServiceOptions {
    ...
    public static class Parameters {
         ...
         */
        public RerankServiceOptions.Parameters defaultValue(Object defaultValue) {
         ...
         * @return the current {@code Parameters} instance for method chaining
         */
        public RerankServiceOptions.Parameters type(String type) {
            this.type = type;
            return this;
        }
         ...
         * @return the current {@code Parameters} instance for method chaining
         */
        public RerankServiceOptions.Parameters help(String help) {
            this.help = help;
            return this;
        }
         ...
         * @return the current {@code Parameters} instance for method chaining
         */
        public RerankServiceOptions.Parameters required(boolean required) {
