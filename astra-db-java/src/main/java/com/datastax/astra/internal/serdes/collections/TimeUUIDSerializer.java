 ...
 */
public class TimeUUIDSerializer extends StdSerializer<TimeUUID> {
     ...
     *      type
     */
    public TimeUUIDSerializer(Class<TimeUUID> t) {
        super(t);
    }

    /** {@inheritDoc} */
    @Override
    public void serialize(TimeUUID uuidv6, JsonGenerator gen, SerializerProvider provider) throws IOException {
//                gen.writeStartObject();
//                gen.writeStringField("$uuid", uuidv6.toString());
          //      gen.writeEndObject();
        gen.writeString(uuidv6 != null ? uuidv6.toString() : null);
    }
}
