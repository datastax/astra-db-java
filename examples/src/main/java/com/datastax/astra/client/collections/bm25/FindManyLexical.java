...
public class FindManyLexical {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CollectionFindOptions options = new CollectionFindOptions()
                .sort(Sort.lexical("Fortune favours the bold"));
        CollectionFindCursor<Document, Document> cursor =
                cLexical.find(filter, options);
        ...
        cLexical.find(
                        // Filter
                        Filters.match("Fortune favours the bold"),
                        // Sort
                        new CollectionFindOptions().sort(Sort.lexical("Fortune favours the bold")))
