...
class AstraDbEmbeddingStoreIT extends EmbeddingStoreIT {
    ...
    void testAddEmbeddingAndFindRelevant() {
        ...
        EmbeddingSearchResult<TextSegment> result = smallStore.search(request);
    ...
    void should_add_embedding_with_segment_with_metadata() throws InterruptedException {
        ...
        Thread.sleep(1000);
        // Build a search request and execute
        EmbeddingSearchRequest request = EmbeddingSearchRequest.builder()
                .queryEmbedding(embedding)   // your existing query embedding
                .maxResults(1)
                .build();
        ...
        assertThat(embeddingStore().search(EmbeddingSearchRequest.builder()
                ...
                .maxResults(1)
                .build()).matches()).isEqualTo(result.matches());
    }
