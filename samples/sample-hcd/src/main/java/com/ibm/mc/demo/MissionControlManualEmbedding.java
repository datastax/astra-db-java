...
public class MissionControlManualEmbedding {

    private static final Logger log = LoggerFactory.getLogger(MissionControlManualEmbedding.class);
    ...
    static Properties loadProperties() {
        ...
        try (InputStream input = MissionControlManualEmbedding.class.getClassLoader()
