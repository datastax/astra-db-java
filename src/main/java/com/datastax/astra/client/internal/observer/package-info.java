 ...
 * <p>
 * Central to this package is the {@link com.datastax.astra.internal.observer.CommandObserver} interface, which defines the methods
 ...
 * <ul>
 *     <li>{@link com.datastax.astra.internal.observer.CommandObserver} - The interface that all observers must implement.
 *     Observers are notified of command execution results through the methods defined in this interface.</li>
 *     <li>{@link com.datastax.astra.internal.observer.LoggingCommandObserver} - A concrete implementation of the {@code CommandObserver}
 ...
 * </p>
 */
package com.datastax.astra.internal.observer;
