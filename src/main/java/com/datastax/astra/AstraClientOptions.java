 ...
 */
@Data @Builder
public class AstraClientOptions {
    ...
    public static final String DEFAULT_CALLER_VERSION =
            AstraClientOptions.class.getPackage().getImplementationVersion() != null ?
            AstraClientOptions.class.getPackage().getImplementationVersion() : "dev";
